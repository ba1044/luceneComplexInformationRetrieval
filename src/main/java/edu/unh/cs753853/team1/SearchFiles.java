...
public class SearchFiles {
  ...
  *//** Simple command-line based search demo. *//*
  public static void main(String[] args) throws Exception 
  {
    ...
    } else {      in = new BufferedReader(new InputStreamReader(System.in, StandardCharsets.UTF_8));
    }
  ...
  public static void doPagingSearch(BufferedReader in, IndexSearcher searcher, Query query, 
    ...
    while (true) {
      ...
      for (int i = start; i < end; i++) {
        ...
        if (paragraphId != null) {
          System.out.println((i+1) + ". " +" Para Id: " +paragraphId);
          String title = doc.get("paragraphContent");
          if (title != null) {
           System.out.println("   Title: " + doc.get("paragraphContent"));
          }
